...
| `orders`        | Listado global de órdenes (`/orders`), el detalle de una orden con el ciclo de vida de su envío (`/orders/:orderId`) y los pasos 1 y 2 del alta manual (`/orders/new`: cliente y productos; `/orders/new/shipping`: origen y destino; el paso 3 es TESIS-59)                                                                                                                           |
